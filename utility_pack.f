      ...
      integer, allocatable :: mx_guest(:),mn_guest(:)
...
c     statistics file input channel
      ...
      save origenergy, mx_guest, mn_guest
...
c      if(idnode.eq.0)write(nrite,"('maxalloc: ', i9)")maxalloc
      ...
      allocate(mx_guest(ntpguest), stat=fail(85))
      allocate(mn_guest(ntpguest), stat=fail(86))
      do i=1,na
        if(fail(i).gt.0)then
