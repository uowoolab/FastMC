...
c*********************************************************************
     ...
     &ntpguest,rcut,rvdw,nwind,tmpdelr)
c*********************************************************************
c
...
c      chainstats(istat+1) = <N>
c      chainstats(istat+2) = <E>
c      chainstats(istat+3) = <EN>
c      chainstats(istat+4) = <N2>
c      chainstats(istat+5) = <E2>
c      chainstats(istat+6) = <NF>
c      chainstats(istat+7) = <Q_st>
c      chainstats(istat+8) = <C_v> 
c      chainstats(istat+9) = stdN
c      chainstats(istat+10) = stdE
c      chainstats(istat+11) = stdEN
c      chainstats(istat+12) = stdN2
c      chainstats(istat+13) = stdE2
c      chainstats(istat+14) = stdNF  
c      chainstats(istat+15) = stdQ_st
c      chainstats(istat+16) = stdC_v
c      
c      avgwindow(1) = <N>
c      avgwindow(2) = <E>
c      avgwindow(3) = <EN>
...
c      if(idnode.eq.0)write(nrite,"('maxalloc: ', i9)")maxalloc
      ...
      allocate(mcinsf(ntpguest),stat=fail(34))
      ...
      allocate(mcswif(ntpguest),stat=fail(42))
      allocate(mcmvnorm(ntpguest),stat=fail(43))
      allocate(accept_disp(ntpguest),stat=fail(44))
